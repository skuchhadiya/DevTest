...
namespace DeveloperTest.Migrations
{
    ...
    [Migration("20200714091057_AddNewTable_Customers")]
    partial class AddNewTable_Customers
    {
            ...
            modelBuilder.Entity("DeveloperTest.Database.Models.Job", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            JobId = 1,
                            Engineer = "Test",
                            When = new DateTime(2020, 7, 14, 10, 10, 56, 760, DateTimeKind.Local).AddTicks(3100)
                        });
                });
